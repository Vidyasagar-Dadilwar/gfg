<h2><a href="https://leetcode.com/problems/maximum-difference-between-even-and-odd-frequency-i">3753. Maximum Difference Between Even and Odd Frequency I</a></h2><p>You are given a string <code>s</code> consisting of lowercase English letters.</p>
