<h2><a href="https://leetcode.com/problems/find-if-digit-game-can-be-won">3515. Find if Digit Game Can Be Won</a></h2><p>You are given an array of <strong>positive</strong> integers <code>nums</code>.</p>
