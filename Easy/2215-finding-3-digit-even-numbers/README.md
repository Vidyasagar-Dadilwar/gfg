<h2><a href="https://leetcode.com/problems/finding-3-digit-even-numbers">2215. Finding 3-Digit Even Numbers</a></h2><p>You are given an integer array <code>digits</code>, where each element is a digit. The array may contain duplicates.</p>
