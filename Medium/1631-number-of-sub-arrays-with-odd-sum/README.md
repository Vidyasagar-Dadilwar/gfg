<h2><a href="https://leetcode.com/problems/number-of-sub-arrays-with-odd-sum">1631. Number of Sub-arrays With Odd Sum</a></h2><p>Given an array of integers <code>arr</code>, return <em>the number of subarrays with an <strong>odd</strong> sum</em>.</p>
