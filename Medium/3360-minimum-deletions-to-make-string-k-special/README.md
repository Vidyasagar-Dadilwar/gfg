<h2><a href="https://leetcode.com/problems/minimum-deletions-to-make-string-k-special">3360. Minimum Deletions to Make String K-Special</a></h2><p>You are given a string <code>word</code> and an integer <code>k</code>.</p>
