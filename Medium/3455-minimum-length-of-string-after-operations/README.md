<h2><a href="https://leetcode.com/problems/minimum-length-of-string-after-operations">3455. Minimum Length of String After Operations</a></h2><p>You are given a string <code>s</code>.</p>
